...
# Leggere due numeri in input (N e M) e utilizzarli per sommare tutti i numeri compresi tra N e M utilizzando un ciclo while.
...
# Esegui una somma cumulativa dei numeri inseriti dall'utente fino a quando viene inserito il numero 0 utilizzando un ciclo while.
